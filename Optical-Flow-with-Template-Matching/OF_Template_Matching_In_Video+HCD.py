...
if __name__=="__main__":
    ...
    cap = cv.VideoCapture(r"..\Video_Data\istockphoto-507652134-640_adpp_is.mp4")
    # cap = cv.VideoCapture(r"..\Video_Data\istockphoto-488561205-640_adpp_is.mp4")
    ...
    while (cap.isOpened()):
        ...
        if ret == True:
            ...
            if frame_counter % 10 == 0 and flag == 0 and stop_code == False:
                ...
                # flag = findTemplateFromvideo(frame, "../images/template_image_main.PNG")
                flag = findTemplateFromvideo(frame, "../images/template_image_gray_suv_car.PNG")
                # flag = findTemplateFromvideo(frame, "../images/template_image_gray_sports_car.PNG")
                # flag = findTemplateFromvideo(frame, "../images/template_image_video2_red_car_3.PNG")
                ...
                #                                                       "../images/template_image_main.PNG")

                pt1, pt2, pt3, pt4, res, w, h = findTemplateFromvideo(frame,
                                                                      "../images/template_image_gray_suv_car.PNG")
                # pt1, pt2, pt3, pt4, res, w, h = findTemplateFromvideo(frame,
                #                                                        "../images/template_image_gray_sports_car.PNG")

                # pt1, pt2, pt3, pt4, res, w, h = findTemplateFromvideo(frame,
                #                                                       "../images/template_image_video2_red_car_3.PNG")
                x1 = pt1
                y1 = pt2
                x2 = x1 + w
                y2 = y1 + h
